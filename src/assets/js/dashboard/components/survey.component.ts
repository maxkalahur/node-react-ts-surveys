...
export default (survey: TDashboardSurveyItem) => {
    ...
    return `
      <div class="survey-box">
          <div class="survey-header"><input class="survey-title" item-id="142" type="text" value="${survey.title}"  data-type="editSurveyName"></div>
          <div class="survey-body">
            <div class="folder-here"><img src="/img/icons/folder.svg"><strong class="folder-name">${survey.organizationName}</strong><span id="folder-item" item-id="${survey.organizationId}" class="removeFolderFromSurvey" data-folder="${survey.organizationName}" folder-id="${survey.organizationId}"><img src="/img/icons/trash.svg"></span></div>
          ...
          <div class="survey-bottom">
            <div class="row">
                <div class="col-md-12"><a href="/dashboard/${survey.id}" class="btn btn-link">Preview</a><a href="#" item-id="142" class="deleteSurveyButton btn btn-link" >Delete</a><a href="${survey.link}" target="_blank" class="btn btn-link">Live Preview</a></div>
            </div>
          </div>
      </div>
